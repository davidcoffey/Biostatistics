...
Standard error (${se}$) of the mean is how far the sample mean deviates from the population mean.The standard error of the mean is estimated by $\frac{s}{\sqrt{n}}$.
