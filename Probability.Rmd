...
library(caret)
sensitivity(factor(MProtein), factor(BonyLesions))
```
...
library(caret)
specificity(factor(MProtein), factor(BonyLesions))
```
...
library(caret)
posPredValue(factor(MProtein), factor(BonyLesions))
```
...
library(caret)
negPredValue(factor(MProtein), factor(BonyLesions))
```
